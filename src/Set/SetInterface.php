 ...
 * that affects equals comparisons while the object is an element in the set. A special case 
 * of this prohibition is that it is not permissible for a set to contain itself as an element.
 ...
 * on the types of their elements. Attempting to query the presence of an ineligible 
 * element may throw an exception, or it may simply return false; some implementations will exhibit the 
 * former behavior and some will exhibit the latter. More generally, attempting an operation on an 
 * ineligible element whose completion would not result in the insertion of an ineligible element into 
 * the set may throw an exception or it may succeed, at the option of the implementation. 
